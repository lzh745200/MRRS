...
def test_v17(real_db_session):from app.api.v1.supported_village import _process_import_row,_FIELD_NAMES;vals=["v17","d","u","GZ","QN","LB","JL",None,None,None,None,None,None,None,None,None];col_map={name:i for i,name in enumerate(_FIELD_NAMES)};ok,err=_process_import_row(tuple(vals),col_map,real_db_session,2);assert ok
